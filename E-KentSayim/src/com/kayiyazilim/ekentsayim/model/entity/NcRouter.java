...
@Entity
public class NcRouter implements Serializable {
	...
	public String getKartPort() {
		return kartPort;
	}

	public void setKartPort(String kartPort) {
		this.kartPort = kartPort;
	}
