...
public class SunucuEndpoint {
	...
	public Response searchBarkod(@PathParam("barkod") Integer barkod) {
		Sunucu entity = dao.searchRest(barkod, null);
		if (entity != null)
	...
	public Response searchSeriNo(@PathParam("cihazSeriNo") String cihazSeriNo) {
		Sunucu entity = dao.searchRest(0, cihazSeriNo);
		if (entity != null)
			return Response.ok(entity).build();
		return Response.noContent().build();
	}
	...
	@Produces("application/json")
	public Sunucu create(Sunucu entity) {
	...
	@GET
	@Produces("application/json")
	public List<Sunucu> listAll(@QueryParam("start") Integer startPosition,
			@QueryParam("max") Integer maxResult) {
		List<Sunucu> results = dao.findAll();
		return results;
	}
	...
	@Path("/{id:[0-9][0-9]*}")
	@Consumes("application/json")
	public Response update(@PathParam("id") int id, Sunucu entity) {
		if (entity == null) {
