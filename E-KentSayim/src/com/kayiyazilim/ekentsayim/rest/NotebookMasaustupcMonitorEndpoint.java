 ...
 */
@Stateless
@Path("/notebookmasaustupcmonitor")
public class NotebookMasaustupcMonitorEndpoint {
	@EJB
	...
	public Response searchBarkod(@PathParam("barkod") Integer barkod) {
		NoteBook_MasaustuPC_Monitor entity = dao.searchRest(barkod, null);
		if (entity != null)
	...
	public Response searchSeriNo(@PathParam("cihazSeriNo") String cihazSeriNo) {
		NoteBook_MasaustuPC_Monitor entity = dao.searchRest(0, cihazSeriNo);
		if (entity != null)
			return Response.ok(entity).build();
		return Response.noContent().build();
	}
	...
	@Produces("application/json")
	public NoteBook_MasaustuPC_Monitor create(NoteBook_MasaustuPC_Monitor entity) {
	...
	public Response deleteById(@PathParam("id") int id) {
		NoteBook_MasaustuPC_Monitor entity = dao.find(id);
		if (entity == null) {
	...
	public Response findById(@PathParam("id") int id) {
		NoteBook_MasaustuPC_Monitor entity;
		try {
			entity = dao.find(id);
	...
	@GET
	@Produces("application/json")
	public List<NoteBook_MasaustuPC_Monitor> listAll() {
		List<NoteBook_MasaustuPC_Monitor> results = dao.findAll();
		return results;
	}
