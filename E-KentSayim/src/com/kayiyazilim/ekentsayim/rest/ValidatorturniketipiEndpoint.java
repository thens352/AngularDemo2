 ...
 */
@Stateless
@Path("/validatorturniketipi")
public class ValidatorturniketipiEndpoint {
	@EJB
	private ValidatorTurnikeTipiDao dao;
	...
	public ValidatorTurnikeTipi create(ValidatorTurnikeTipi entity) {
	...
	public Response deleteById(@PathParam("id") int id) {
		ValidatorTurnikeTipi entity = dao.find(id);
		if (entity == null) {
	...
	public Response searchBarkod(@PathParam("barkod") Integer barkod) {
		ValidatorTurnikeTipi entity = dao.searchRest(barkod, null);
		if (entity != null)
	...
	public Response searchSeriNo(@PathParam("cihazSeriNo") String cihazSeriNo) {
		ValidatorTurnikeTipi entity = dao.searchRest(0, cihazSeriNo);
		if (entity != null)
			return Response.ok(entity).build();
		return Response.noContent().build();
	}
	...
	@GET
	@Produces("application/json")
	public List<ValidatorTurnikeTipi> listAll() {
		List<ValidatorTurnikeTipi> results = dao.findAll();
		return results;
	}
	...
	@Path("/{id:[0-9][0-9]*}")
	@Consumes("application/json")
	public Response update(@PathParam("id") int id, ValidatorTurnikeTipi entity) {
		if (entity == null) {
