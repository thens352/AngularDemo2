...
@Stateless
@Path("/ceptelefonu")
public class CeptelefonuEndpoint {
	@EJB
	...
	public Response searchBarkod(@PathParam("barkod") Integer barkod) {
		CepTelefonu entity = dao.searchRest(barkod, null);
		if (entity != null)
	...
	public Response searchSeriNo(@PathParam("cihazSeriNo") String cihazSeriNo) {
		CepTelefonu entity = dao.searchRest(0, cihazSeriNo);
		if (entity != null)
			return Response.ok(entity).build();
		return Response.noContent().build();
	}
	...
	@Produces("application/json")
	public CepTelefonu create(CepTelefonu entity) {
	...
	public Response deleteById(@PathParam("id") int id) {
		CepTelefonu entity = dao.find(id);
		if (entity == null) {
	...
	@GET
	@Produces("application/json")
	public List<CepTelefonu> listAll() {
		List<CepTelefonu> results = dao.findAll();
		return results;
	}
	...
	@Path("/{id:[0-9][0-9]*}")
	@Consumes("application/json")
	public Response update(@PathParam("id") int id, CepTelefonu entity) {
		if (entity == null) {
