 ...
 */
@Stateless
@Path("/mufettiselterminali")
public class MufettiselterminaliEndpoint {
	@EJB
	private MufettisElTerminaliDao dao;
	@EJB
	...
	public Response searchBarkod(@PathParam("barkod") Integer barkod) {
		MufettisElTerminali entity = dao.searchRest(barkod, null);
		if (entity != null)
	...
	public Response searchSeriNo(@PathParam("cihazSeriNo") String cihazSeriNo) {
		MufettisElTerminali entity = dao.searchRest(0, cihazSeriNo);
		if (entity != null)
			return Response.ok(entity).build();
		return Response.noContent().build();
	}
	...
	@Produces("application/json")
	public MufettisElTerminali create(MufettisElTerminali entity) {
	...
	public Response deleteById(@PathParam("id") int id) {
		MufettisElTerminali entity = dao.find(id);
		if (entity == null) {
	...
	@GET
	@Produces("application/json")
	public List<MufettisElTerminali> listAll() {
		List<MufettisElTerminali> results = dao.findAll();
		return results;
	}
	...
	@Path("/{id:[0-9][0-9]*}")
	@Consumes("application/json")
	public Response update(@PathParam("id") int id, MufettisElTerminali entity) {
		if (entity == null) {
