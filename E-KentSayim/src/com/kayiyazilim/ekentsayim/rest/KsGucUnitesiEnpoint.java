...
@Stateless
@Path("/ksgucunitesi")
public class KsGucUnitesiEnpoint {
	@EJB
	private KsGucUnitesiDao dao;
	@EJB
	...
	public Response searchBarkod(@PathParam("barkod") Integer barkod) {
		KsGucUnitesi entity = dao.searchRest(barkod, null);
		if (entity != null)
	...
	public Response searchSeriNo(@PathParam("cihazSeriNo") String cihazSeriNo) {
		KsGucUnitesi entity = dao.searchRest(0, cihazSeriNo);
		if (entity != null)
			return Response.ok(entity).build();
		return Response.noContent().build();
	}
	...
	@Produces("application/json")
	public KsGucUnitesi create(KsGucUnitesi entity) {
	...
	public Response deleteById(@PathParam("id") int id) {
		KsGucUnitesi entity = dao.find(id);
		if (entity == null) {
	...
	@GET
	@Produces("application/json")
	public List<KsGucUnitesi> listAll() {
		List<KsGucUnitesi> results = dao.findAll();
		return results;
	}
	...
	@Path("/{id:[0-9][0-9]*}")
	@Consumes("application/json")
	public Response update(@PathParam("id") int id, KsGucUnitesi entity) {
		if (entity == null) {
