...
public class LcdEndpoint {
	...
	@GET
	@Produces("application/json")
	public List<LCD> listAll() {
		List<LCD> results = dao.findAll();
		return results;
	}
	...
	@Path("/{id:[0-9][0-9]*}")
	@Consumes("application/json")
	public Response update(@PathParam("id") int id, LCD entity) {
		if (entity == null) {
