...
@Stateless
@Path("/masatelefonu")
public class MasatelefonuEndpoint {
	@EJB
	...
	public Response searchBarkod(@PathParam("barkod") Integer barkod) {
		MasaTelefonu entity = dao.searchRest(barkod, null);
		if (entity != null)
	...
	public Response searchSeriNo(@PathParam("cihazSeriNo") String cihazSeriNo) {
		MasaTelefonu entity = dao.searchRest(0, cihazSeriNo);
		if (entity != null)
			return Response.ok(entity).build();
		return Response.noContent().build();
	}
	...
	@Produces("application/json")
	public MasaTelefonu create(MasaTelefonu entity) {
	...
	public Response deleteById(@PathParam("id") int id) {
		MasaTelefonu entity = dao.find(id);
		if (entity == null) {
	...
	@GET
	@Produces("application/json")
	public List<MasaTelefonu> listAll(
			@QueryParam("start") Integer startPosition,
			@QueryParam("max") Integer maxResult) {
		List<MasaTelefonu> results = dao.findAll();
		return results;
	}
	...
	@Path("/{id:[0-9][0-9]*}")
	@Consumes("application/json")
	public Response update(@PathParam("id") int id, MasaTelefonu entity) {
		if (entity == null) {
