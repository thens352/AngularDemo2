...
@Stateless
@Path("/akillidurak")
public class AkillidurakEndpoint {
	@EJB
	private AkilliDurakDao dao;
	@EJB
	...
	public Response searchBarkod(@PathParam("barkod") Integer barkod) {
		AkilliDurak entity = dao.searchRest(barkod, null);
		if (entity != null)
	...
	public Response searchSeriNo(@PathParam("cihazSeriNo") String cihazSeriNo) {
		AkilliDurak entity = dao.searchRest(0, cihazSeriNo);
		if (entity != null)
			return Response.ok(entity).build();
		return Response.noContent().build();
	}
	...
	public AkilliDurak create(AkilliDurak entity) {
	...
	public Response deleteById(@PathParam("id") int id) {
		AkilliDurak entity = dao.find(id);
		if (entity == null) {
	...
	@GET
	@Produces("application/json")
	public List<AkilliDurak> listAll() {
		List<AkilliDurak> results = dao.findAll();
		return results;
	}
	...
	@Path("/{id:[0-9][0-9]*}")
	@Consumes("application/json")
	public Response update(@PathParam("id") int id, AkilliDurak entity) {
		if (entity == null) {
