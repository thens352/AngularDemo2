 ...
 */
@Stateless
@Path("/otobusguzergahpanosu")
public class OtobusguzergahpanosuEndpoint {

	@EJB
	private OtobusGuzergahPanosuDao dao;
	@EJB
	...
	public Response searchBarkod(@PathParam("barkod") Integer barkod) {
		OtobusGuzergahPanosu entity = dao.searchRest(barkod, null);
		if (entity != null)
	...
	public Response searchSeriNo(@PathParam("cihazSeriNo") String cihazSeriNo) {
		OtobusGuzergahPanosu entity = dao.searchRest(0, cihazSeriNo);
		if (entity != null)
			return Response.ok(entity).build();
		return Response.noContent().build();
	}
	...
	public OtobusGuzergahPanosu create(OtobusGuzergahPanosu entity) {
	...
	public Response deleteById(@PathParam("id") int id) {
		OtobusGuzergahPanosu entity = dao.find(id);
		if (entity == null) {
	...
	@GET
	@Produces("application/json")
	public List<OtobusGuzergahPanosu> listAll() {
		List<OtobusGuzergahPanosu> results = dao.findAll();
		return results;
	}
	...
	@Path("/{id:[0-9][0-9]*}")
	@Consumes("application/json")
	public Response update(@PathParam("id") int id, OtobusGuzergahPanosu entity) {
		if (entity == null) {
