 ...
 */
@Stateless
@Path("/validatorotobustipi")
public class ValidatorotobustipiEndpoint {
	@EJB
	private ValidatorOtobusTipiDao dao;
	...
	public Response searchBarkod(@PathParam("barkod") Integer barkod) {
		ValidatorOtobusTipi entity = dao.searchRest(barkod, null);
		if (entity != null)
	...
	public Response searchSeriNo(@PathParam("cihazSeriNo") String cihazSeriNo) {
		ValidatorOtobusTipi entity = dao.searchRest(0, cihazSeriNo);
		if (entity != null)
			return Response.ok(entity).build();
		return Response.noContent().build();
	}
	...
	@Produces("application/json")
	public ValidatorOtobusTipi create(ValidatorOtobusTipi entity) {
		entity.setGununTarihi(new Date()); entity.setGununTarihi(new Date()); dao.persist(entity);
	...
	public Response deleteById(@PathParam("id") int id) {
		ValidatorOtobusTipi entity = dao.find(id);
		if (entity == null) {
	...
	@GET
	@Produces("application/json")
	public List<ValidatorOtobusTipi> listAll() {
		List<ValidatorOtobusTipi> results = dao.findAll();
		return results;
	}
	...
	@Path("/{id:[0-9][0-9]*}")
	@Consumes("application/json")
	public Response update(@PathParam("id") int id, ValidatorOtobusTipi entity) {
		if (entity == null) {
