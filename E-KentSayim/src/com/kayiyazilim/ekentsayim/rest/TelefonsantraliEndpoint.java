 ...
 */
@Stateless
@Path("/telefonsantrali")
public class TelefonsantraliEndpoint {
	@EJB
	...
	public Response searchBarkod(@PathParam("barkod") Integer barkod) {
		TelefonSantrali entity = dao.searchRest(barkod, null);
		if (entity != null)
	...
	public Response searchSeriNo(@PathParam("cihazSeriNo") String cihazSeriNo) {
		TelefonSantrali entity = dao.searchRest(0, cihazSeriNo);
		if (entity != null)
			return Response.ok(entity).build();
		return Response.noContent().build();
	}
	...
	@Produces("application/json")
	public TelefonSantrali create(TelefonSantrali entity) {
	...
	public Response deleteById(@PathParam("id") int id) {
		TelefonSantrali entity = dao.find(id);
		if (entity == null) {
	...
	@GET
	@Produces("application/json")
	public List<TelefonSantrali> listAll(
			@QueryParam("start") Integer startPosition,
			@QueryParam("max") Integer maxResult) {
		List<TelefonSantrali> results = dao.findAll();
		return results;
	}
	...
	@Path("/{id:[0-9][0-9]*}")
	@Consumes("application/json")
	public Response update(@PathParam("id") int id, TelefonSantrali entity) {
		if (entity == null) {
