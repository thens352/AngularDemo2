 ...
 */
@Stateless
@Path("/cctvalarmklimatv")
public class CctvAlarmKlimaTvEndpoint {
	@EJB
	...
	public Response searchBarkod(@PathParam("barkod") Integer barkod) {
		CCTV_Alarm_Klima_TV entity = dao.searchRest(barkod, null);
		if (entity != null)
	...
	public Response searchSeriNo(@PathParam("cihazSeriNo") String cihazSeriNo) {
		CCTV_Alarm_Klima_TV entity = dao.searchRest(0, cihazSeriNo);
		if (entity != null)
			return Response.ok(entity).build();
		return Response.noContent().build();
	}
	...
	@Produces("application/json")
	public CCTV_Alarm_Klima_TV create(CCTV_Alarm_Klima_TV entity) {
	...
	public Response deleteById(@PathParam("id") int id) {
		CCTV_Alarm_Klima_TV entity = dao.find(id);
		if (entity == null) {
	...
	@GET
	@Produces("application/json")
	public List<CCTV_Alarm_Klima_TV> listAll() {
		List<CCTV_Alarm_Klima_TV> results = dao.findAll();
		return results;
	}
	...
	@Path("/{id:[0-9][0-9]*}")
	@Consumes("application/json")
	public Response update(@PathParam("id") int id, CCTV_Alarm_Klima_TV entity) {
		if (entity == null) {
